...
import (
	...
	"github.com/NickDiPreta1/snippetbox/internal/models"
	"github.com/NickDiPreta1/snippetbox/internal/models/validator"
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedEmail(form.Email), "email", "This must be a valid email address")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	if url := app.sessionManager.PopString(r.Context(), "redirectPathAfterLogin"); url != "" {
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	err = app.users.Update(userID, form.CurrentPassword, form.NewPassword)
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			form.AddFieldError("currentPassword", "Wrong password entered")
			data := app.newTemplateData(r)
			data.Form = form
			app.render(w, http.StatusUnprocessableEntity, "password.tmpl.html", data)
		} else {
